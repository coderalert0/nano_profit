class CreatePriceDriftsAndIncreaseVendorRatePrecision < ActiveRecord::Migration[8.0]
  def change
    ...
    change_column :vendor_rates, :input_rate_per_1k,  :decimal, precision: 15, scale: 6, null: false
    change_column :vendor_rates, :output_rate_per_1k, :decimal, precision: 15, scale: 6, null: false
  end
end
